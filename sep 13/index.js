...
txt2.placeholder = " "
txt2.id = "txt2"
txt2.style.borderWidth = "1px"
bodyCont.appendChild(txt2)

let check = document.createElement("button")
check.classList.add("btn", "btn-dark", "btn-lg", "mt-3", "col-md-2")
