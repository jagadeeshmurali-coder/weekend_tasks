...
async function weatherData(item){
    ...
    let api_key = "fc02164e2fa7a437822b3362cd6d7bb8";
...
top_head.innerText = "Get Weather for your country here"
top_head.style.color = "red"
...
async function createCards(id){
    ...
    cardbody.style.backgroundImage = "linear-gradient(to left, red , #DAC8B3)"
